...
const ROMANIA_CITY_PRESETS = [
	{ key: "teleorman", label: "Alexandria", lat: 43.9667, lon: 25.3333 },
	{ key: "alba", label: "Alba Iulia", lat: 46.0734, lon: 23.5780 },
	{ key: "arad", label: "Arad", lat: 46.1866, lon: 21.3123 },
	{ key: "bacau", label: "Bacau", lat: 46.5670, lon: 26.9144 },
	{ key: "maramures", label: "Baia Mare", lat: 47.6591, lon: 23.5700 },
	{ key: "bistrita-nasaud", label: "Bistrita", lat: 47.1332, lon: 24.4833 },
	...
	{ key: "ilfov", label: "Buftea", lat: 44.5621, lon: 25.9555 },
	{ key: "buzau", label: "Buzau", lat: 45.1511, lon: 26.8183 },
	{ key: "calarasi", label: "Calarasi", lat: 44.1956, lon: 27.3328 },
	{ key: "cluj", label: "Cluj-Napoca", lat: 46.7712, lon: 23.5856 },
	{ key: "constanta", label: "Constanta", lat: 44.1737, lon: 28.6518 },
	{ key: "dolj", label: "Craiova", lat: 44.3303, lon: 23.8052 },
	{ key: "hunedoara", label: "Deva", lat: 45.8735, lon: 22.9015 },
	{ key: "mehedinti", label: "Drobeta-Turnu Severin", lat: 44.6269, lon: 22.6599 },
	{ key: "vrancea", label: "Focsani", lat: 45.6967, lon: 27.1853 },
	...
	{ key: "harghita", label: "Miercurea Ciuc", lat: 46.3606, lon: 25.8039 },
	{ key: "bihor", label: "Oradea", lat: 47.0465, lon: 21.9190 },
	{ key: "neamt", label: "Piatra Neamt", lat: 46.9275, lon: 26.3712 },
	{ key: "arges", label: "Pitesti", lat: 44.8565, lon: 24.8692 },
	{ key: "prahova", label: "Ploiesti", lat: 44.9453, lon: 26.0153 },
	{ key: "valcea", label: "Ramnicu Valcea", lat: 45.1036, lon: 24.3662 },
	{ key: "caras-severin", label: "Resita", lat: 45.2938, lon: 21.8845 },
	{ key: "satu-mare", label: "Satu Mare", lat: 47.7983, lon: 22.8838 },
	{ key: "covasna", label: "Sfantu Gheorghe", lat: 45.8587, lon: 25.7854 },
	{ key: "sibiu", label: "Sibiu", lat: 45.7983, lon: 24.1256 },
	{ key: "olt", label: "Slatina", lat: 44.4333, lon: 24.3667 },
	{ key: "ialomita", label: "Slobozia", lat: 44.5638, lon: 27.3627 },
	{ key: "suceava", label: "Suceava", lat: 47.6514, lon: 26.2558 },
	{ key: "dambovita", label: "Targoviste", lat: 44.9333, lon: 25.4500 },
	{ key: "gorj", label: "Targu Jiu", lat: 45.0373, lon: 23.2721 },
	{ key: "mures", label: "Targu Mures", lat: 46.5362, lon: 24.5587 },
	{ key: "timis", label: "Timisoara", lat: 45.7537, lon: 21.2257 },
	{ key: "tulcea", label: "Tulcea", lat: 45.1833, lon: 28.8000 },
	{ key: "vaslui", label: "Vaslui", lat: 46.6333, lon: 27.7333 },
	{ key: "salaj", label: "Zalau", lat: 47.1764, lon: 23.0569 }
];
...
function handleApplyResult (result) {
	...
	if (result.reloaded) {
		...
		const toastText = translationsMap && translationsMap[lang] && translationsMap[lang].toast_reload
			? translationsMap[lang].toast_reload
			: "Mirror reloaded";
		showToast(toastText);
		return true;
	}
